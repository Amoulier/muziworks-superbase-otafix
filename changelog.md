...
- Add Muzi Works Base Uno, Base Duo, and Superbase support while preserving
  the original `muzi-Base-Board` UF2 identity, USB identifiers, LED wiring,
  and S140 6.1.1 memory layout.
